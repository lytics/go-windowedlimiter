...
func TestBasic(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		l, key := setup(t, ctx, rate, interval, 49*time.Millisecond)
...
func TestConcurrent(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		l, key := setup(t, ctx, rate, interval, 100*time.Millisecond)
...
func TestRefreshKey(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		rate := int64(5)
		interval := 1000 * time.Millisecond
		l, key := setup(t, ctx, rate, interval, 1*time.Millisecond)
...
func TestRefresh(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		rate := int64(5)
		interval := 100 * time.Millisecond
		l, key1 := setup(t, ctx, rate, interval, 49*time.Millisecond)
